...
describe Bone do
  ...
  it 'with complex attributes' do
    ...
    expect(ItemCommand.new(rod).to_s).to eq %q<i bone 1 {Owner:BornToCode,Age:-32768,Unbreakable:1,HideFlags:5,display:{Name:"Rod of Authority!"},AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Operation:0,Amount:999999.0,UUIDMost:0,UUIDLeast:0},{AttributeName:"generic.followRange",Name:"generic.followRange",Operation:2,Amount:-0.99,UUIDMost:0,UUIDLeast:0},{AttributeName:"generic.maxHealth",Name:"generic.maxHealth",Operation:2,Amount:1.0,UUIDMost:0,UUIDLeast:0}],ench:[{id:19,lvl:10},{id:21,lvl:100}]}>
  end
