...
describe Wolf do
  ...
  it 'with complex attributes' do
    ...
    wolf.silent
    wolf.healrate = 40
    wolf.attrs   << AttackDamage.new(30)
    wolf.attrs   << FollowRange.new(99999)
    wolf.attrs   << KnockbackResistance.new(99)
